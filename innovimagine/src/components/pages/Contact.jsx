  ...
  return (
    <div className="min-h-screen bg-navy-900 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 pt-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">hello@innovimagine.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900/60 p-8 rounded-2xl backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className=" w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-opacity-20 transition-all outline-none"
            ...
            <div>
              <label className="block text-gray-300 mb-2">Service of Interest</label>
              <select
                className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-opacity-20 transition-all outline-none"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-opacity-20 transition-all outline-none resize-none"
